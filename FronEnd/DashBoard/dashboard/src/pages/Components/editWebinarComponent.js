...
const WebinarForm = ({ editingWebinar, setIsEditing }) => {
    const [webinarData, setWebinarData] = useState(editingWebinar);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.put('http://localhost:9000/api/v1/webminars/'+editingWebinar._id, webinarData);
